...
public class SendEmail 
{
	 ...
	 * 
	 * // email ID of Sender. String sender = "sender@gmail.com";
	 * 
	 * // using host as localhost String host = "127.0.0.1";
	 * 
	 ...
	 * 
	 * // Set Subject: subject of the email message.setSubject("This is Suject");
	 * 
	 ...
	 * MimeBodyPart(); String filename = "attachment.txt" DataSource source = new
	 * FileDataSource(filename); messageBodyPart2.setDataHandler(new
